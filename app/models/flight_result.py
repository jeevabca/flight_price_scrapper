...
class FlightResult(Base):
    ...
    flight_number: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    currency: Mapped[str] = mapped_column(String(50), default="INR")
    cabin_class: Mapped[str] = mapped_column(String(100), default="economy")
